...
if __name__=='__main__':
    ...
    simulation['HL1'] = Ornstein_Uhlenbeck.simulation(mu=0, sigma=1, theta=2**(-1/150), n=10000)
    simulation['HL2'] = Ornstein_Uhlenbeck.simulation(mu=0, sigma=1, theta=2**(-1/70), n=10000)
    simulation['HL3'] = Ornstein_Uhlenbeck.simulation(mu=0, sigma=1, theta=2**(-1/20), n=10000)
    simulation.iloc[0] = 0.2
    L = [30, 100]
    ...
    sns.regplot(y=t_values.RW, x=returns.RW, scatter_kws={'color': 'blue'}, line_kws={'color':'red'})
    ax2 = plt.subplot(142)
    ax2.set(xlim=xlim)
    ax2.title.set_text('Half-life: 200')
    sns.regplot(y=t_values.HL1, x=returns.HL1, scatter_kws={'color': 'blue'}, line_kws={'color': 'red'})
    ax3 = plt.subplot(143)
    ax3.set(xlim=xlim)
    ax3.title.set_text('Half-life: 100')
    sns.regplot(y=t_values.HL2, x=returns.HL2, scatter_kws={'color': 'blue'}, line_kws={'color': 'red'})
    ax4 = plt.subplot(144)
    ax4.set(xlim=xlim)
    ax4.title.set_text('Half-life: 50')
    sns.regplot(y=t_values.HL3, x=returns.HL3, scatter_kws={'color': 'blue'}, line_kws={'color': 'red'})
